...
public class _254_LegendaryTales extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, L2NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("gilmore_q254_05.htm")) {
            ...
            tokenizer.nextToken();
            if (ConfigValue._254_LegendaryTalesCustomReward.length > 0) {
                if (Rnd.chance(ConfigValue._254_LegendaryTalesCustomRewardChance)) {
                    st.giveItems(ConfigValue._254_LegendaryTalesCustomReward[Rnd.get(ConfigValue._254_LegendaryTalesCustomReward.length)], 1);
                } else
                    st.getPlayer().sendMessage(new CustomMessage("_254_LegendaryTales.chance", st.getPlayer()));
