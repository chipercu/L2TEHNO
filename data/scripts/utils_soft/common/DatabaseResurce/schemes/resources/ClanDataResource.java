...
import static utils_soft.common.DatabaseResurce.schemes.resources.ClanDataResource.*;
...
@Table(
        ...
        fields = {
                ...
                @Column(is_null = YES , type = VARCHAR , type_size = 45 , name = CLAN_NAME , defValue = "NULL"),
                @Column(is_null = NO , type = TINYINT , type_size = 0 , name = CLAN_LEVEL , defValue = "0"),
                @Column(is_null = NO , type = TINYINT , type_size = 0 , name = HAS_CASTLE , defValue = "0"),
                @Column(is_null = NO , type = TINYINT , type_size = 0 , name = HAS_FORTRESS , defValue = "0"),
                @Column(is_null = NO , type = TINYINT , type_size = 0 , name = HAS_HIDEOUT , defValue = "0"),
                ...
                @Column(is_null = YES , type = VARBINARY , type_size = 256 , name = CREST , defValue = "NULL"),
                @Column(is_null = YES , type = VARBINARY , type_size = 8192 , name = LARGECREST , defValue = "NULL"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = REPUTATION_SCORE , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = WAREHOUSE , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = EXPELLED_MEMBER , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = LEAVED_ALLY , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = DISSOLVED_ALLY , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = AUCTION_BID_AT , defValue = "0"),
                @Column(is_null = NO , type = SMALLINT , type_size = 0 , name = AIRSHIP , defValue = "-1"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = POINT , defValue = "20"),
        }
)
