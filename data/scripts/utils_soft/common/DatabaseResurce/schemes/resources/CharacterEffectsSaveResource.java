...
import static utils_soft.common.DatabaseResurce.schemes.resources.CharacterEffectsSaveResource.*;
...
@Table(
        ...
        fields = {
                ...
                @Column(is_null = NO , type = MEDIUMINT , type_size = 0 , name = SKILL_ID , defValue = "0"),
                @Column(is_null = NO , type = TINYINT , type_size = 0 , name = SKILL_LEVEL , defValue = "0"),
                @Column(is_null = NO , type = TINYINT , type_size = 0 , name = EFFECT_COUNT , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = EFFECT_CUR_TIME , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = DURATION , defValue = "0"),
                @Column(is_null = NO , type = TINYINT , type_size = 0 , name = ORDER , defValue = "0"),
