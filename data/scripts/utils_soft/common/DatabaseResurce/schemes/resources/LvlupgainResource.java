...
import static utils_soft.common.DatabaseResurce.schemes.resources.LvlupgainResource.*;
...
@Table(
        ...
        primary_key = {CLASSID},
        fields = {
                @Column(is_null = NO , type = INT , type_size = 0 , name = CLASSID , defValue = "0"),
                @Column(is_null = NO , type = DECIMAL , type_size = 0 , name = DEFAULTHPBASE , defValue = "0.0"),
                @Column(is_null = NO , type = DECIMAL , type_size = 0 , name = DEFAULTHPADD , defValue = "0.00"),
                @Column(is_null = NO , type = DECIMAL , type_size = 0 , name = DEFAULTHPMOD , defValue = "0.00"),
                @Column(is_null = NO , type = DECIMAL , type_size = 0 , name = DEFAULTCPBASE , defValue = "0.0"),
                @Column(is_null = NO , type = DECIMAL , type_size = 0 , name = DEFAULTCPADD , defValue = "0.00"),
                @Column(is_null = NO , type = DECIMAL , type_size = 0 , name = DEFAULTCPMOD , defValue = "0.00"),
                @Column(is_null = NO , type = DECIMAL , type_size = 0 , name = DEFAULTMPBASE , defValue = "0.0"),
                @Column(is_null = NO , type = DECIMAL , type_size = 0 , name = DEFAULTMPADD , defValue = "0.00"),
                @Column(is_null = NO , type = DECIMAL , type_size = 0 , name = DEFAULTMPMOD , defValue = "0.00"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = CLASS_LVL , defValue = "0"),
        }
)
