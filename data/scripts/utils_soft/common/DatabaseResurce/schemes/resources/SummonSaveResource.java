...
import static utils_soft.common.DatabaseResurce.schemes.resources.SummonSaveResource.*;
...
@Table(
        ...
        fields = {
                ...
                @Column(is_null = NO , type = INT , type_size = 0 , name = LIFE_TIME , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = ITEM_CONSUME_ID_IN_TIME , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = ITEM_CONSUME_COUNT_IN_TIME , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = ITEM_CONSUME_DELAY , defValue = "0"),
                @Column(is_null = NO , type = DOUBLE , type_size = 0 , name = EXP_PENALTY , defValue = "0"),
        }
)
