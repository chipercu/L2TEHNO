...
import static utils_soft.common.DatabaseResurce.schemes.resources.PetDataResource.*;
...
@Table(
        ...
        fields = {
                @Column(is_null = NO , type = VARCHAR , type_size = 25 , name = TYPE , defValue = ""),
                @Column(is_null = NO , type = INT , type_size = 0 , name = ID , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = LEVEL , defValue = "0"),
                @Column(is_null = NO , type = DECIMAL , type_size = 0 , name = EXP , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = HP , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = MP , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = PATK , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = PDEF , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = MATK , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = MDEF , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = ACC , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = EVASION , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = CRIT , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = SPEED , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = ATK_SPEED , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = CAST_SPEED , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = MAX_MEAL , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = BATTLE_MEAL , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = NORMAL_MEAL , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = LOAD_MAX , defValue = "0"),
                @Column(is_null = NO , type = DECIMAL , type_size = 0 , name = HPREGEN , defValue = "0.00"),
                @Column(is_null = NO , type = DECIMAL , type_size = 0 , name = MPREGEN , defValue = "0.00"),
                @Column(is_null = NO , type = DECIMAL , type_size = 0 , name = GET_EXP_TYPE , defValue = "0.00"),
                @Column(is_null = NO , type = SMALLINT , type_size = 0 , name = SPIRITSHOT_COUNT , defValue = "0"),
                @Column(is_null = NO , type = SMALLINT , type_size = 0 , name = SOULSHOT_COUNT , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = ITEM , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = FOOD , defValue = "-1"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = ADD_MEAL , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = HUNGRY_LIMIT , defValue = "55"),
                @Column(is_null = NO , type = ENUM , type_size = 5 , name = MOUNTABE , defValue = "false"),
        }
)
