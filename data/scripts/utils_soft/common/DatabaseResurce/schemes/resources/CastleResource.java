...
import static utils_soft.common.DatabaseResurce.schemes.resources.CastleResource.*;
...
@Table(
        ...
        fields = {
                ...
                @Column(is_null = NO , type = VARCHAR , type_size = 25 , name = NAME , defValue = "null"),
                @Column(is_null = NO , type = TINYINT , type_size = 0 , name = TAX_PERCENT , defValue = "15"),
                @Column(is_null = NO , type = BIGINT , type_size = 0 , name = TREASURY , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = SIEGE_DATE , defValue = "0"),
                @Column(is_null = NO , type = TINYINT , type_size = 0 , name = SIEGE_DAY_OF_WEEK , defValue = "1"),
                @Column(is_null = NO , type = TINYINT , type_size = 0 , name = SIEGE_HOUR_OF_DAY , defValue = "16"),
                @Column(is_null = NO , type = TINYINT , type_size = 0 , name = TOWN_ID , defValue = "0"),
                @Column(is_null = NO , type = VARCHAR , type_size = 32 , name = SKILLS , defValue = "0;0"),
                @Column(is_null = NO , type = VARCHAR , type_size = 32 , name = FLAGS , defValue = "0;0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = OWN_DATE , defValue = "0"),
                @Column(is_null = NO , type = INT , type_size = 0 , name = DOMINION_LORD , defValue = "0"),
                @Column(is_null = NO , type = TINYINT , type_size = 0 , name = SET_SIEGE , defValue = "1"),
        }
)
