...
import static utils_soft.common.DatabaseResurce.schemes.resources.SpawnlistResource.*;
...
@Table(
        ...
        fields = {
                @Column(is_null = NO , type = VARCHAR , type_size = 35 , name = LOCATION , defValue = ""),
                ...
                @Column(is_null = NO , type = INT , type_size = 0 , name = RESPAWN_DELAY_RND , defValue = "0"),
                @Column(is_null = NO , type = VARCHAR , type_size = 325 , name = LOC_ID , defValue = "0"),
                @Column(is_null = NO , type = VARCHAR , type_size = 325 , name = BANED_LOC_ID , defValue = "0"),
