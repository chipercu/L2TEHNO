...
@Table(
        ...
        fields = {
                ...
                @Field(name = RACE_ID , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = PARENT , data_type = "tinyint" , defValue = @DefValue(Integer = 255)),
                @Field(name = LEVEL , data_type = "tinyint" , defValue = @DefValue(Integer = 0)),
                @Field(name = S_TR , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = C_ON , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = D_EX , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = __IN_T , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = W_IT , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = M_EN , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = P__AT_K , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = P__DE_F , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = M__AT_K , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = M__DE_F , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = P__SP_D , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = M__SP_D , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = A_CC , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = C_RI_TI_CA_L , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = E_VA_SI_ON , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = R_UN__SP_D , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = W_AL_K__SP_D , data_type = "int" , defValue = @DefValue(Integer = 0)),
                ...
                @Field(name = CAN_CRAFT , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = M__UN_K1 , data_type = "decimal" , defValue = @DefValue(Double = 0.00)),
                @Field(name = M__UN_K2 , data_type = "decimal" , defValue = @DefValue(Double = 0.000000)),
                @Field(name = M__CO_L__R , data_type = "decimal" , defValue = @DefValue(Double = 0.0)),
                @Field(name = M__CO_L__H , data_type = "decimal" , defValue = @DefValue(Double = 0.0)),
                @Field(name = F__UN_K1 , data_type = "decimal" , defValue = @DefValue(Double = 0.00)),
                @Field(name = F__UN_K2 , data_type = "decimal" , defValue = @DefValue(Double = 0.000000)),
                @Field(name = F__CO_L__R , data_type = "decimal" , defValue = @DefValue(Double = 0.0)),
                @Field(name = F__CO_L__H , data_type = "decimal" , defValue = @DefValue(Double = 0.0)),
                @Field(name = ITEMS1 , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = ITEMS2 , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = ITEMS3 , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = ITEMS4 , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = ITEMS5 , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = P_ATK_MOD , data_type = "float" , defValue = @DefValue(Double = 1)),
                @Field(name = M_ATK_MOD , data_type = "float" , defValue = @DefValue(Double = 1)),
                @Field(name = P_DEF_MOD , data_type = "float" , defValue = @DefValue(Double = 1)),
                @Field(name = M_DEF_MOD , data_type = "float" , defValue = @DefValue(Double = 1)),
                @Field(name = M_ATK_SPD_MOD , data_type = "float" , defValue = @DefValue(Double = 1)),
                @Field(name = P_ATK_SPD_MOD , data_type = "float" , defValue = @DefValue(Double = 1)),
                @Field(name = M_ATK_CRIT_CHANCE_MOD , data_type = "float" , defValue = @DefValue(Double = 1)),
                @Field(name = P_ATK_CRIT_CHANCE_MOD , data_type = "float" , defValue = @DefValue(Double = 1)),
                @Field(name = P_CRITICAL_DAMAGE_PER_MOD , data_type = "float" , defValue = @DefValue(Double = 1)),
                @Field(name = P_CRITICAL_DAMAGE_DIFF_MOD , data_type = "int" , defValue = @DefValue(Integer = 0)),
                @Field(name = HP_MOD , data_type = "float" , defValue = @DefValue(Double = 1)),
                @Field(name = MP_MOD , data_type = "float" , defValue = @DefValue(Double = 1)),
                @Field(name = P_CRITICAL_RATE_MOD , data_type = "float" , defValue = @DefValue(Double = 1)),
        }
)
