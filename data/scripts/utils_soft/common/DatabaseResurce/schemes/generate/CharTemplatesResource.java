...
import static utils_soft.common.DatabaseResurce.schemes.generate.CharTemplatesResource.*;
...
@Table(
        ...
        fields = {
                ...
                @Field(name = CLASS_NAME , type = VARCHAR , type_size = 20 , nullable = false , defValue = @DefValue(String = "")),
                @Field(name = RACE_ID , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = PARENT , type = TINYINT , nullable = true , defValue = @DefValue(Integer = 255)),
                @Field(name = LEVEL , type = TINYINT , nullable = true , defValue = @DefValue(Integer = 0)),
                @Field(name = S_TR , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = C_ON , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = D_EX , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = __IN_T , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = W_IT , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = M_EN , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = P__AT_K , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = P__DE_F , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = M__AT_K , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = M__DE_F , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = P__SP_D , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = M__SP_D , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = A_CC , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = C_RI_TI_CA_L , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = E_VA_SI_ON , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = R_UN__SP_D , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = W_AL_K__SP_D , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                ...
                @Field(name = CAN_CRAFT , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = M__UN_K1 , type = DECIMAL , nullable = false , defValue = @DefValue(Double = 0.00)),
                @Field(name = M__UN_K2 , type = DECIMAL , nullable = false , defValue = @DefValue(Double = 0.000000)),
                @Field(name = M__CO_L__R , type = DECIMAL , nullable = false , defValue = @DefValue(Double = 0.0)),
                @Field(name = M__CO_L__H , type = DECIMAL , nullable = false , defValue = @DefValue(Double = 0.0)),
                @Field(name = F__UN_K1 , type = DECIMAL , nullable = false , defValue = @DefValue(Double = 0.00)),
                @Field(name = F__UN_K2 , type = DECIMAL , nullable = false , defValue = @DefValue(Double = 0.000000)),
                @Field(name = F__CO_L__R , type = DECIMAL , nullable = false , defValue = @DefValue(Double = 0.0)),
                @Field(name = F__CO_L__H , type = DECIMAL , nullable = false , defValue = @DefValue(Double = 0.0)),
                @Field(name = ITEMS1 , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = ITEMS2 , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = ITEMS3 , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = ITEMS4 , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = ITEMS5 , type = INT , nullable = false , defValue = @DefValue(Integer = 0)),
                @Field(name = P_ATK_MOD , type = FLOAT , nullable = true , defValue = @DefValue(Double = 1)),
                @Field(name = M_ATK_MOD , type = FLOAT , nullable = true , defValue = @DefValue(Double = 1)),
                @Field(name = P_DEF_MOD , type = FLOAT , nullable = true , defValue = @DefValue(Double = 1)),
                @Field(name = M_DEF_MOD , type = FLOAT , nullable = true , defValue = @DefValue(Double = 1)),
                @Field(name = M_ATK_SPD_MOD , type = FLOAT , nullable = true , defValue = @DefValue(Double = 1)),
                @Field(name = P_ATK_SPD_MOD , type = FLOAT , nullable = true , defValue = @DefValue(Double = 1)),
                @Field(name = M_ATK_CRIT_CHANCE_MOD , type = FLOAT , nullable = true , defValue = @DefValue(Double = 1)),
                @Field(name = P_ATK_CRIT_CHANCE_MOD , type = FLOAT , nullable = true , defValue = @DefValue(Double = 1)),
                @Field(name = P_CRITICAL_DAMAGE_PER_MOD , type = FLOAT , nullable = true , defValue = @DefValue(Double = 1)),
                @Field(name = P_CRITICAL_DAMAGE_DIFF_MOD , type = INT , nullable = true , defValue = @DefValue(Integer = 0)),
                @Field(name = HP_MOD , type = FLOAT , nullable = true , defValue = @DefValue(Double = 1)),
                @Field(name = MP_MOD , type = FLOAT , nullable = true , defValue = @DefValue(Double = 1)),
                @Field(name = P_CRITICAL_RATE_MOD , type = FLOAT , nullable = true , defValue = @DefValue(Double = 1)),
        }
)
...
super(CharTemplatesResource.class);
    ...
    public CharTemplatesResource(String ClassId){
        super(CharTemplatesResource.class);
