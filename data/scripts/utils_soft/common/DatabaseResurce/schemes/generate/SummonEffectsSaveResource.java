...
import static utils_soft.common.DatabaseResurce.schemes.generate.SummonEffectsSaveResource.*;
...
super(SummonEffectsSaveResource.class);
    ...
    public SummonEffectsSaveResource(String char_obj_id,String npc_id,String skill_id){
        super(SummonEffectsSaveResource.class);
