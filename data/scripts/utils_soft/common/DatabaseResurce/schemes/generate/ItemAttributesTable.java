...
import static utils_soft.common.DatabaseResurce.schemes.generate.ItemAttributesTable.*;

@Table(
        name = "item_attributes",
        fields = {
                @Field(name = ITEM_ID),
                @Field(name = AUG_ATTRIBUTES),
                @Field(name = AUG_SKILL_ID),
                @Field(name = AUG_SKILL_LEVEL),
                @Field(name = ELEM_TYPE),
                @Field(name = ELEM_VALUE),
                @Field(name = ELEM0),
                @Field(name = ELEM1),
                @Field(name = ELEM2),
                @Field(name = ELEM3),
...
public class ItemAttributesTable extends DataBaseTable<ItemAttributesTable> {
...
super(ItemAttributesTable.class);
}
