...
import static utils_soft.common.DatabaseResurce.schemes.generate.SevenSignsStatusTable.*;
...
public class SevenSignsStatusTable extends DataBaseTable<SevenSignsStatusTable> {
    ...
    public SevenSignsStatusTable() {
super(SevenSignsStatusTable.class);
}
