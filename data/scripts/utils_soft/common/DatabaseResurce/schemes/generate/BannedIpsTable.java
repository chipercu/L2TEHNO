...
import static utils_soft.common.DatabaseResurce.schemes.generate.BannedIpsTable.*;
...
public class BannedIpsTable extends DataBaseTable<BannedIpsTable> {
    ...
    public BannedIpsTable() {
super(BannedIpsTable.class);
}
