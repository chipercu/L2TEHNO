...
public class Strings
{
	...
	{
		Files.cacheClean();
		String RuPath = "./data/html-ru.zip";
		String EnPath = "./data/html-en.zip";
		if (Boolean.parseBoolean(System.getenv("DEVELOP"))){
			 RuPath = "data/html-ru.zip";
			 EnPath = "data/html-en.zip";
		}

		Files.loadPtsHtml(RuPath);
		Files.loadPtsHtml(EnPath);
