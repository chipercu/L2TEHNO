...
import l2open.gameserver.serverpackets.custom.ConfigPacket;
import l2open.gameserver.serverpackets.custom.CustomFontsPacket;
import l2open.gameserver.serverpackets.custom.KeyPacket;
import l2open.gameserver.clientpackets.L2GameClientPacket;
import l2open.gameserver.serverpackets.custom.ScreenTextInfoPacket;
...
//		activeChar.sendPacket(new Interface.impl.CustomFontsPacket().sendFontInfos());
//		activeChar.sendPacket(new Interface.impl.ScreenTextInfoPacket().sendTextInfos());
