...
public class L2LoginServer {
    ...
    public L2LoginServer() {
        ...
        String LOG_NAME = "./config/log.properties"; // Name of log file
		if (Boolean.parseBoolean(System.getenv("DEVELOP"))){
			LOG_NAME = "java/config/log.properties"; // Name of log file
		}
        ...
        try {
            ...
            is = Files.newInputStream(new File(LOG_NAME).toPath());
