...
import static l2open.database.schemes.resources.ItemsResource.*;
...
@Table(
        ...
        fields = {
                ...
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = ITEM_ID , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = VISUAL_ITEM_ID , defValue = "0"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.VARCHAR , type_size = 100 , name = NAME , defValue = "NULL"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.BIGINT , type_size = 0 , name = COUNT , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = ENCHANT_LEVEL , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = VISUAL_ENCHANT_LEVEL , defValue = "-1"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.ENUM , type_size = 10 , name = CLASS , defValue = "OTHER"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.ENUM , type_size = 13 , name = LOC , defValue = "null"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.INT , type_size = 0 , name = LOC_DATA , defValue = "NULL"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = CUSTOM_TYPE1 , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = CUSTOM_TYPE2 , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = SHADOW_LIFE_TIME , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = FLAGS , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = ENERGY , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.ENUM , type_size = 5 , name = TEMPORAL , defValue = "false"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.BIGINT , type_size = 0 , name = ENCHANT_TIME , defValue = "0"),
        }
)
