...
import static l2open.database.schemes.resources.SkillsResource.*;
...
@Table(
        ...
        fields = {
                ...
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = LEARN , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.TEXT , type_size = 65535 , name = OPERATE_TYPE , defValue = "null"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.VARCHAR , type_size = 100 , name = NAME , defValue = ""),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.TINYINT , type_size = 0 , name = IS_MAGIC , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = MAGIC_LEVEL , defValue = "null"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = ACTIVATE_RATE , defValue = "null"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = EFFECT_POINT , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = MP_CONSUME1 , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = MP_CONSUME2 , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = HP_CONSUME , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = CAST_RANGE , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.DOUBLE , type_size = 0 , name = SKILL_HIT_TIME , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.DOUBLE , type_size = 0 , name = COOL_TIME , defValue = "null"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.DOUBLE , type_size = 0 , name = HIT_CANCEL_TIME , defValue = "null"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = POWER , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.VARCHAR , type_size = 50 , name = ENCHANT , defValue = "0"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.INT , type_size = 0 , name = REUSE , defValue = "-1"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.TINYINT , type_size = 0 , name = OLYMPIAD_USE , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.TINYINT , type_size = 0 , name = STATIC_HITTIME , defValue = "0"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.TINYINT , type_size = 0 , name = STATIC_REUSE , defValue = "0"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.INT , type_size = 0 , name = ABNORMAL_TIME , defValue = "-1"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.VARCHAR , type_size = 40 , name = ABNORMAL_TYPE , defValue = "none"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = ABNORMAL_LV , defValue = "-1"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.TINYINT , type_size = 0 , name = ABNORMAL_INSTANT , defValue = "-1"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.TINYINT , type_size = 0 , name = BUFF_PROTECT_LEVEL , defValue = "-1"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.VARCHAR , type_size = 30 , name = TRAIT , defValue = "trait_none"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = LV_BONUS_RATE , defValue = "null"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.VARCHAR , type_size = 5 , name = BASIC_PROPERTY , defValue = "null"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.VARCHAR , type_size = 10 , name = NEXT_ACTION , defValue = "null"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.ENUM , type_size = 17 , name = TARGET_TYPE , defValue = "none"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.ENUM , type_size = 19 , name = AFFECT_SCOPE , defValue = "none"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.ENUM , type_size = 20 , name = AFFECT_OBJECT , defValue = "none"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = AFFECT_RANGE , defValue = "-1"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.VARCHAR , type_size = 7 , name = AFFECT_LIMIT , defValue = "0;0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.VARCHAR , type_size = 16 , name = FAN_RANGE , defValue = "0;0;0;0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = EFFECTIVE_RANGE , defValue = "-1"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = EFFECT_POINT2 , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.SMALLINT , type_size = 0 , name = IRREPLACEABLE_BUFF , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.VARCHAR , type_size = 31 , name = ABNORMAL_VISUAL_EFFECT , defValue = "ave_none"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.TEXT , type_size = 65535 , name = ICON , defValue = "null"),
        }
)
