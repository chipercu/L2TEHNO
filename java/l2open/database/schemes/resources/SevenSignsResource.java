...
import static l2open.database.schemes.resources.SevenSignsResource.*;
...
@Table(
        ...
        fields = {
                ...
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.ENUM , type_size = 8 , name = CABAL , defValue = "No Cabal"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.TINYINT , type_size = 0 , name = SEAL , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = DAWN_RED_STONES , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = DAWN_GREEN_STONES , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = DAWN_BLUE_STONES , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = DAWN_ANCIENT_ADENA_AMOUNT , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = DAWN_CONTRIBUTION_SCORE , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = DUSK_RED_STONES , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = DUSK_GREEN_STONES , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = DUSK_BLUE_STONES , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = DUSK_ANCIENT_ADENA_AMOUNT , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = DUSK_CONTRIBUTION_SCORE , defValue = "0"),
        }
)
