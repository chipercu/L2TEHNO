...
import static l2open.database.schemes.resources.CharTemplatesResource.*;
...
@Table(
        ...
        fields = {
                ...
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.VARCHAR , type_size = 20 , name = CLASS_NAME , defValue = ""),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = RACE_ID , defValue = "0"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.TINYINT , type_size = 0 , name = PARENT , defValue = "255"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.TINYINT , type_size = 0 , name = LEVEL , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = S_TR , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = C_ON , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = D_EX , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = __IN_T , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = W_IT , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = M_EN , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = P__AT_K , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = P__DE_F , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = M__AT_K , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = M__DE_F , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = P__SP_D , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = M__SP_D , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = A_CC , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = C_RI_TI_CA_L , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = E_VA_SI_ON , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = R_UN__SP_D , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = W_AL_K__SP_D , defValue = "0"),
                ...
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = CAN_CRAFT , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.DECIMAL , type_size = 0 , name = M__UN_K1 , defValue = "0.00"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.DECIMAL , type_size = 0 , name = M__UN_K2 , defValue = "0.000000"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.DECIMAL , type_size = 0 , name = M__CO_L__R , defValue = "0.0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.DECIMAL , type_size = 0 , name = M__CO_L__H , defValue = "0.0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.DECIMAL , type_size = 0 , name = F__UN_K1 , defValue = "0.00"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.DECIMAL , type_size = 0 , name = F__UN_K2 , defValue = "0.000000"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.DECIMAL , type_size = 0 , name = F__CO_L__R , defValue = "0.0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.DECIMAL , type_size = 0 , name = F__CO_L__H , defValue = "0.0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = ITEMS1 , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = ITEMS2 , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = ITEMS3 , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = ITEMS4 , defValue = "0"),
                @Column(is_null = IS_NULLABLE.NO , type = DATA_TYPE.INT , type_size = 0 , name = ITEMS5 , defValue = "0"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.FLOAT , type_size = 0 , name = P_ATK_MOD , defValue = "1"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.FLOAT , type_size = 0 , name = M_ATK_MOD , defValue = "1"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.FLOAT , type_size = 0 , name = P_DEF_MOD , defValue = "1"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.FLOAT , type_size = 0 , name = M_DEF_MOD , defValue = "1"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.FLOAT , type_size = 0 , name = M_ATK_SPD_MOD , defValue = "1"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.FLOAT , type_size = 0 , name = P_ATK_SPD_MOD , defValue = "1"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.FLOAT , type_size = 0 , name = M_ATK_CRIT_CHANCE_MOD , defValue = "1"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.FLOAT , type_size = 0 , name = P_ATK_CRIT_CHANCE_MOD , defValue = "1"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.FLOAT , type_size = 0 , name = P_CRITICAL_DAMAGE_PER_MOD , defValue = "1"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.INT , type_size = 0 , name = P_CRITICAL_DAMAGE_DIFF_MOD , defValue = "0"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.FLOAT , type_size = 0 , name = HP_MOD , defValue = "1"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.FLOAT , type_size = 0 , name = MP_MOD , defValue = "1"),
                @Column(is_null = IS_NULLABLE.YES , type = DATA_TYPE.FLOAT , type_size = 0 , name = P_CRITICAL_RATE_MOD , defValue = "1"),
        }
)
